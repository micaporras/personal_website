...
function Landing() {
    ...
    return (
        <section className="min-h-screen md:pt-0 pt-20 pb-10 md:px-10 px-2 lg:px-10 flex md:flex-row flex-col md:justify-center items-center gap-6 md:gap-4 lg:gap-8">
