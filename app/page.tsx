...
export default function Home() {
  return (
    <main className="flex flex-col md:px-10 px-2">
      <Navbar />
      <section className="min-h-screen md:mt-0 mt-20 pb-10 lg:px-10 flex md:flex-row flex-col md:justify-center items-center md:gap-4 lg:gap-10">
        ...
        <div className="flex flex-col w-full justify-center items-center md:items-start">
          ...
          />
          <p className="p-2 md:p-0 md:pr-2 playfair md:text-lg text-sm font-medium tracking-wide text-justify">With experience in software development and building technology-driven applications. 
