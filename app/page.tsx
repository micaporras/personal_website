...
export default function Home() {
  return (
    <main className="flex flex-col md:px-10">
      <Navbar />
      <section className="mt-15 p-2 flex md:flex-row flex-col justify-center items-center md:gap-4">
        <div className="flex flex-col w-full justify-center items-center pt-3 md:pt-5">
          ...
          width = {300}
          height = {200}
          className="w-80 sm:w-60 md:w-100 lg:w-130 h-auto pt-3"
        ...
        <div className="flex flex-col w-full justify-center items-center md:items-start">
          ...
          <TypeAnimation
            ...
            speed={50}
            repeat={Infinity}
            className="font-extrabold text-(--sec) lg:text-5xl md:text-3xl text-xl md:pt-0 md:pb-3"
          />
          ...
          <div className="flex md:flex-row flex-col w-full gap-2 md:pt-4 pt-3 font-semibold px-15 md:px-0">
            <button 
            ...
            <a
            className="flex flex-row justify-center items-center gap-1 px-3 py-2 bg-(--prim) text-white rounded-md hover:bg-(--sec) cursor-pointer"
